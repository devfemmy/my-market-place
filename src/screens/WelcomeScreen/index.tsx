    ...
    const welcomeInfo = [
        {
            ...
            title: "I want to create a store where i can add products and sell on Bazara.",
            type: "Seller"
        },
        {
            id: 2,
            ...
            <ScrollView>
                <View style={styles.containerView} >
                    <View style={styles.div}>
                        ...
                        <Text text="We are happy to have you onboard the Bazara platform." fontSize={14} style={styles.text} />
                        <View>
                            {
                                welcomeInfo?.map((data: any) => {
                                    return <WelcomeCard key={data?.id} header={data?.header} title={data?.title} type={data?.type} selected={selected} handleClick={() => handleClick(data?.type)} />
                                })
                            }
                    ...
                    <View style={styles.btn}>
                        <Button text="Continue" onPress={() => navigation.navigate("StoreCreationScreen")} />
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView >
